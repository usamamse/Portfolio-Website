...
export function Skills() {
  return (
    (<div className="fkek flex-col mt-[100px] justify-start items-center">
      <h3 className="text-white text-xl mb-[-50px] md:mb-[-100px] font-bold text-neutral-200">Skills</h3>
      <div>
